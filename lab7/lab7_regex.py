...
def make_camel(text):
    ca = re.split('_+', text)
    ca1 = ca[0] + ''.join(map(lambda x: x.title(), ca[1:]))
    return ca1

test = "Система_для_инфузии_Vogt_Medical"
res = make_camel(test)
print(res)


#8
text = "БанковскаяКарта"
